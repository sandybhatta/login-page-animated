...
function initLoginForm() {
  ...
  password.addEventListener('input', function(e) {
    ...
    let checkText = password.value;

    

    // Update UI based on the length of the cleaned input
    if (val === 10) {
        document.querySelector(".phoneVerifier").style.backgroundColor = "green";
    } else {
        
        document.querySelector(".phoneVerifier").style.backgroundColor = "red";
    }
});
